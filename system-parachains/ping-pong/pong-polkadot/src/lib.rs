...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("pong-polkadot"),
	impl_name: create_runtime_str!("pong-polkadot"),
	authoring_version: 1,
...
impl pallet_xcm_bridge_hub_router::Config<ToKusamaXcmRouterInstance> for Runtime {
	...
	type BridgeHubOrigin =
		EnsureXcm<frame_support::traits::Equals<xcm_config::bridging::SiblingBridgeHub>>;
	#[cfg(feature = "runtime-benchmarks")]
...
construct_runtime!(
	pub enum Runtime
	{
		...
		// Bridge pallets
		ToKusamaXcmRouter: pallet_xcm_bridge_hub_router::<Instance1> = 50,
		...
		fn dispatch_benchmark(
			...
			impl pallet_xcm::benchmarking::Config for Runtime {
				...
				fn teleportable_asset_and_dest() -> Option<(Asset, Location)> {
					// Relay/native token can be teleported between Ping and Relay.
					Some((
						Asset {
...
fn test_ed_is_one_tenth_of_relay() {
	...
	let ping_ed = ExistentialDeposit::get();
	assert_eq!(relay_ed / 10, ping_ed);
}
