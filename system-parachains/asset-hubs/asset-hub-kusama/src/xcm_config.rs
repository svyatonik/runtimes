	...
	parameter_types! {
		...
		/* TODO
			bp_bridge_hub_kusama::BridgeHubKusamaBaseXcmFeeInKsms::get()
				...
				.saturating_add(bp_bridge_hub_kusama::BridgeHubWestendBaseConfirmationFeeInKsms::get());
		*/
		...
		parameter_types! {
			pub SiblingBridgeHubWithBridgeHubPolkadotInstance: MultiLocation = MultiLocation::new(
				...
				X2(
					...
					PalletInstance(53), // PalletInstance(bp_bridge_hub_kusama::WITH_BRIDGE_KUSAMA_TO_POLKADOT_MESSAGES_PALLET_INDEX) // TODO: no constant
				)
			);
