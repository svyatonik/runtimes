...
#export POLKADOT_BRIDGE_HUB_WASM_BLOB=$FELLOWSHIP_FOLDER/system-parachains/bridge-hubs/bridge-hub-polkadot/target/srtool/release/wbuild/bridge-hub-polkadot-runtime/bridge_hub_polkadot_runtime.wasm
