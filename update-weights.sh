#/bin/bash
#cargo build --profile=production -p chain-spec-generator --features runtime-benchmarks
#./target/production/chain-spec-generator bridge-hub-polkadot-local --raw >bh-polkadot-local-raw.json
#./target/production/chain-spec-generator bridge-hub-kusama-local --raw >bh-kusama-local-raw.json
#./target/production/chain-spec-generator asset-hub-polkadot-local --raw >ah-polkadot-local-raw.json
#./target/production/chain-spec-generator asset-hub-kusama-local --raw >ah-kusama-local-raw.json
